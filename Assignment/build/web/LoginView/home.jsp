    ...
    <body style="background-image: url('images/sanhAlpha.jpg');background-size: cover;   background-repeat: no-repeat;  background-position: center;background-attachment: fixed; ">
        <div id="nav-bar">
            ...
            <div id="nav-content">
                ...
                <hr/>
                <div class="nav-button"><i class="fas fa-calendar-alt"></i><span onclick="window.location.href = 'lecturer/schedule?id=1'">Schedule</span></div>
                <hr/>
                <div class="nav-button"><i class="fas fa-pen"></i><span onclick="">Attendance</span></div>
                <hr/>
                <div class="nav-button"><i class="fas fa-graduation-cap"></i><span onclick="">View Score</span></div>
            ...
            <div id="nav-footer">
                <div id="nav-footer-heading">
                    ...
                    <div id="nav-footer-titlebox"><a id="nav-footer-title">${sessionScope.account.displayname}</a><span id="nav-footer-subtitle">Admin</span></div>
